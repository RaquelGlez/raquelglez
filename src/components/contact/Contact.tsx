...
const Contact = () => {
  return (
    <div
      className={`flex justify-center items-center md:mx-auto flex-col ${styles.containerContact}`}
    >
      <h3 className="font-semibold text-current md:mb-8 text-xl ">CONTACTO</h3>
      <div
